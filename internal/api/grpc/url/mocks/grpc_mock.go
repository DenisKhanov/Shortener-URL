...
func (m *MockService) AsyncDeleteUserURLs(ctx context.Context, URLSToDel []string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AsyncDeleteUserURLs", ctx, URLSToDel)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// GetStorageStatus mocks base method.
func (m *MockService) GetStorageStatus(ctx context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetStorageStatus", ctx)
	ret0, _ := ret[0].(error)
	return ret0
}

// GetStorageStatus indicates an expected call of GetStorageStatus.
func (mr *MockServiceMockRecorder) GetStorageStatus(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStorageStatus", reflect.TypeOf((*MockService)(nil).GetStorageStatus), ctx)
}
